...
MainWatcher = (function() {
  ...
  MainWatcher.prototype.attachGrandmabook = function(el, text) {
    var $el, binded_callback, callback, view, _enabled, _enabled_url, _tooltip,
      _this = this;
    $el = $(el);
    if (!$el.hasClass("grandmabook-nc-email")) {
      $el.addClass("grandmabook grandmabook-nc-email grandmabook-nc-email-" + this.emailId);
      _enabled = true;
      _enabled_url = "";
  ...
  MainWatcher.prototype.parseDOM = function() {
    var dialog, dialogs, email, email_elem, email_pattern, err, popout, popouts, replies, reply, _i, _j, _k, _len, _len1, _len2, _results;
    try {
...
GmailNewComposeEmailTracker = (function() {
  ...
  function GmailNewComposeEmailTracker(emailId, dialogEl, enabled, enabled_url, tooltip, callback) {
    this.emailId = emailId;
    this.dialogEl = dialogEl;
    this.enabled = enabled;
    this.enabled_url = enabled_url;
  ...
  GmailNewComposeEmailTracker.prototype.attachBar = function() {
    ...
    this.ui.trashcan.before(this.render().el);
    ...
    if (!this.enabled) {
      this.ui.label.addClass("grandmabook-disabled");
    } else {
      chrome.storage.sync.get("grandmabook-tip-accepted", function(result) {
        var checkmark, tip;
        checkmark = void 0;
        tip = void 0;
